...
////-----------Step 5------------//
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      // Use unified OTP API: sendOtp(type, value, purpose)
      const response = await sendOtp('mobile', formData.phoneNumber, 'signup');
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      // Use unified OTP API: verifyOtp(type, value, otp, purpose)
      const response = await verifyOtp('mobile', formData.phoneNumber, otpCode, 'signup');
