...
import { termsSections } from "./data/TermsofService.jsx";
  ...
  return (
    <main className="relative text-gray-800 scroll-smooth isolate overflow-x-visible">
      ...
      <header className="max-w-5xl mx-auto px-6 pt-20 pb-6 text-center relative z-10">
        ...
        These terms govern your use of SpotOn's services. By using our platform, you agree to the terms below.
        </p>
        <div className="mt-6">
          <button
...
<ul className="max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2/5 mx-auto px-6 py-3 space-y-2 bg-gray-50 text-sm shadow border-t border-b rounded border-accent-green">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-6 pb-24 space-y-10 text-base leading-relaxed">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-900">Service-Specific Terms</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              to="/legal/powerterms"
              className="p-4 border border-gray-200 rounded-lg hover:border-primary-turquoise transition-colors"
            >
              <h3 className="font-semibold text-gray-900">Power Terms</h3>
              <p className="text-sm text-gray-600 mt-1">Terms and conditions for our power services</p>
            </Link>
            <Link
              to="/legal/broadbandterms"
              className="p-4 border border-gray-200 rounded-lg hover:border-primary-turquoise transition-colors"
            >
              <h3 className="font-semibold text-gray-900">Broadband Terms</h3>
              <p className="text-sm text-gray-600 mt-1">Terms and conditions for our broadband services</p>
            </Link>
            <Link
              to="/legal/mobileterms"
              className="p-4 border border-gray-200 rounded-lg hover:border-primary-turquoise transition-colors"
            >
              <h3 className="font-semibold text-gray-900">Mobile Terms</h3>
              <p className="text-sm text-gray-600 mt-1">Terms and conditions for our mobile services</p>
            </Link>
          </div>
        </div>
      </div>
