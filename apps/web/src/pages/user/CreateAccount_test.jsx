        ...
        <AnimatePresence mode="wait">
          ...
          {!showMethodSelection && (
            ...
            {/* Email Field and Verification */}
              ...
              <div>
                    <label className="px-1 text-start block text-sm font-medium text-slate-300 mb-1">
                  Email Address
                </label>
                  ...
                  <div className="flex-grow">
                    <input
                      ...
                      className={cn(
                             'w-full h-10 rounded-md bg-white/10 py-2 px-3 text-white text-base placeholder-slate-400 border focus:outline-none focus:ring-2 focus:ring-blue-500',
                             emailVerified || emailOtpSent ? 'bg-gray-100/10 cursor-not-allowed' : '',
                             emailError || emailExistsError ? 'border-red-500' : 'border-white/20'
                    )}
                  />
                  <AnimatePresence mode="wait">
                    ...
                    <div className="shrink-0 align-top flex items-center h-10 mt-2">
                  <AnimatePresence mode="wait">
                    {isCheckingEmail ? (
                       <motion.div
                         key="email-checking"
              ...
              <AnimatePresence>
                {emailOtpSent && (
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className={cn(
                          'rounded-md border border-white/20 bg-white/5 px-4 py-3 shadow-sm w-full overflow-hidden',
                  ...
                  >
                      ...
                      {emailOtp.map((digit, index) => (
                        <motion.input
                          ...
                          onKeyDown={(e) =>
                            handleOtpKeyDown(index, e, emailOtp, emailOtpInputRefs, setEmailOtp)
                          }
                          ref={(el) => (emailOtpInputRefs.current[index] = el)}
                          whileFocus={{ scale: 1.1 }}
                              className="w-9 h-9 sm:w-11 sm:h-11 text-center text-base sm:text-lg font-semibold border text-white border-white/20 rounded-md bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                      ))}
                  </div>
                  <AnimatePresence mode="wait">
                      {emailOtpError && (
                           <motion.p
                               ...
                               exit={{ opacity: 0, height: 0 }}
                               transition={{ duration: 0.2 }}
                                   className="mt-2 text-sm text-red-400 overflow-hidden"
                           >
                               {emailOtpError}
                           </motion.p>
                      )}
                    ...
                    <button
                      type="button"
                      onClick={() => handleSendOtp('email')}
                          disabled={!email || emailResendCountdown > 0 || !!emailExistsError}
                          className="text-sm text-blue-400 hover:text-blue-300 disabled:text-slate-500 transition-colors"
                    >
          ...
          <div className="space-y-4">
                ...
                <div className="flex-grow">
                  <input
                    ...
                    className={cn(
                          'w-full h-10 rounded-md bg-white/10 py-2 px-3 text-white text-base placeholder-slate-400 border focus:outline-none focus:ring-2 focus:ring-blue-500',
                          mobileVerified || mobileOtpSent ? 'bg-gray-100/10 cursor-not-allowed' : '',
                          mobileError ? 'border-red-500' : 'border-white/20'
                        )}
                  ...
                  >
                      ...
                      {mobileOtp.map((digit, index) => (
                        <motion.input
                          ...
                          onKeyDown={(e) =>
                            handleOtpKeyDown(index, e, mobileOtp, mobileOtpInputRefs, setMobileOtp)
                          }
                     ...
                     <AnimatePresence mode="wait">
                      ...
                      <button
                        type="button"
                        onClick={() => handleSendOtp('mobile')}
                        disabled={!mobile || mobileResendCountdown > 0}
                            className="text-sm text-blue-400 hover:text-blue-300 disabled:text-slate-500 transition-colors"
                      >
            ...
            <div>
              <div className="flex items-center justify-between">
                    <label className="px-1 text-left block text-sm font-medium text-slate-300">
                  Create a password
                </label>
                <button
                  type="button"
              ...
              <div className="relative">
                <input
                  ...
                  className={cn(
                        'mt-1 block w-full rounded-md px-3 py-2 pr-10 text-base text-white bg-white/10 placeholder-slate-400 border focus:outline-none focus:ring-2 focus:ring-blue-500',
              ...
              <AnimatePresence mode="wait">
                {password && (passwordFieldFocused || passwordStrength < 5) && (
                  <motion.div
                        ...
                        >
                          <span className={cn(
                            'w-4 h-4 rounded-full flex items-center justify-center text-xs font-mono',
                                req.met ? 'bg-green-500/20 text-green-400' : 'bg-white/10 text-slate-400'
                          )}>
                            {req.icon}
                          </span>
                          <span>{req.label}</span>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={cn(
                        'mt-1 block w-full rounded-md px-3 py-2 pr-10 text-base text-white bg-white/10 placeholder-slate-400 border focus:outline-none focus:ring-2 focus:ring-blue-500',
                        confirmPasswordError ? 'border-red-500' : 'border-white/20'
                  )}
              ...
              <AnimatePresence mode="wait">
                {confirmPassword && password && confirmPassword === password && !confirmPasswordError && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, height: 0 }}
                    transition={{ duration: 0.2 }}
                        className="mt-2 flex items-center gap-2 text-green-400 overflow-hidden"
                  >
            ...
            {isSubmitting ? 'Creating account...' : 'Create Account'}
             ...
             <div className="text-center text-sm text-slate-400 mt-4">
              ...
              <a href="/login" className="font-semibold leading-6 text-blue-400 hover:text-blue-300">
                Login
              </a>
            </div>
            </form>
