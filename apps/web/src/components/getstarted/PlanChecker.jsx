...
export default function PlanChecker({ selectedAddress, selectedServices, onContinueToDetails, initialPlans = null, mobilePlans, isLoadingMobilePlans, onPlanSelect, currentPlans, value }) {
  ...
  useEffect(() => {
    ...
    if (plansToUse) {
      ...
      setSelectedMobilePlan(
        plansToUse.mobile?.pricing_id || 
        plansToUse.mobile?.id || 
        null
      );
  ...
  }, [electricityGroup, broadbandGroup, mobileGroup, selectedElectricityPlan, selectedBroadbandPlan, selectedMobilePlan, selectedServices]);
    ...
    const handleTileClick = () => {
      ...
      if (type === "electricity") {
        if (selectedElectricityPlan === planId) {
          ...
          console.log('[PlanChecker] Electricity plan selected:', planId);
        ...
        if (selectedBroadbandPlan === planId) {
          ...
          console.log('[PlanChecker] Broadband plan selected:', planId);
        ...
        if (selectedMobilePlan === planId) {
          ...
          console.log('[PlanChecker] Mobile plan selected:', planId);
  ...
  const handleConfirm = () => {
    console.log('[PlanChecker] Continue button clicked!');
    ...
    console.log('[PlanChecker] Calling onContinueToDetails with plans:', plans);
    if (typeof onContinueToDetails === 'function') {
      onContinueToDetails(plans);
    } else {
      console.error('[PlanChecker] onContinueToDetails is not a function:', typeof onContinueToDetails);
    }
  };
  ...
  console.log('[PlanChecker] isAnyPlanSelected:', isAnyPlanSelected, {
    selectedServices,
    selectedElectricityPlan,
    selectedBroadbandPlan,
    selectedMobilePlan,
    electricityCheck: selectedServices.electricity && selectedElectricityPlan,
    broadbandCheck: selectedServices.broadband && selectedBroadbandPlan,
    mobileCheck: selectedServices.mobile && selectedMobilePlan
  });
