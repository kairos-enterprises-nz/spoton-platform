      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Please carefully review all information below before confirming your registration. 
                  ...
                  {section.content.map((item, itemIndex) => (
                    <div key={itemIndex} className="border-b border-gray-100 dark:border-gray-700 last:border-b-0 pb-2 last:pb-0">
                      <div className="flex flex-col md:flex-row md:items-start">
                        <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 md:w-1/4 md:min-w-[140px]">
                          {item.label}
                        </dt>
                            ...
                            <div className="mt-1.5 bg-gray-50 dark:bg-gray-700/30 rounded-md px-3 py-2">
                              <ul className="space-y-1">
                                {item.details.map((detail, detailIndex) => (
                                  <li key={detailIndex} className="flex flex-col sm:flex-row sm:items-baseline text-sm leading-snug">
                                    <span className="font-medium text-gray-500 dark:text-gray-400 sm:w-1/3">{detail.label}</span>
                                    <span className="text-gray-800 dark:text-gray-200 sm:w-2/3">{detail.value}</span>
                                  </li>
                                ))}
                              </ul>
                            </div>
        ...
        {/* Action Buttons */}
        <div className="sticky bottom-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8 px-6 rounded-t-xl shadow-lg">
          <div className="max-w mx-auto ">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700/50 rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-medium text-white bg-accent-green/60 rounded-full hover:bg-accent-green/80 transition-colors duration-200 flex items-center gap-1"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <label className="relative flex items-center group cursor-pointer pl-4 py-2 transition-all select-none">
                      <span className="flex items-center justify-center h-6 w-6 rounded-full bg-accent-green/10 mr-3">
                  ...
                  {selectedServices?.electricity && termsLinks.electricityTerms && (
                    <div className="relative">
                      ...
                      <label className="relative flex items-center group cursor-pointer pl-4 py-2 transition-all select-none">
                        <span className="flex items-center justify-center h-6 w-6 rounded-full bg-yellow-500/10 mr-3">
                  ...
                  {selectedServices?.broadband && termsLinks.broadbandTerms && (
                    <div className="relative">
                      ...
                      <label className="relative flex items-center group cursor-pointer pl-4 py-2 transition-all select-none">
                        <span className="flex items-center justify-center h-6 w-6 rounded-full bg-purple-500/10 mr-3">
                  ...
                  {selectedServices?.mobile && termsLinks.mobileTerms && (
                    <div className="relative">
                      ...
                      <label className="relative flex items-center group cursor-pointer pl-4 py-2 transition-all select-none">
                        <span className="flex items-center justify-center h-6 w-6 rounded-full bg-pink-500/10 mr-3">
            ...
            <button
              ...
              disabled={isSubmitting || !Object.values(termsAccepted).every(accepted => accepted)}
